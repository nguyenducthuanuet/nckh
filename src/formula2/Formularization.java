...
public abstract class Formularization {
	...
	public List<String> formularize(CtStatement statement,
		...
		String preCondition = getPreCondition(lastReturnFlag, lastBreakFlag, lastContinueFlag);
		...
		if (statement instanceof CtAssignment) {
			...
			WhileFormularization whileF = new WhileFormularization((CtWhile) statement, 
									listVariables, flagVariables, lastReturnFlag);
			f = whileF.getFormula();
		}
...
*/
	...
	public List<String> formularize(CtOperatorAssignment ass) {
	...
	protected void init() {
		...
		whileFlag = new Variable("while", "bool");
		doFlag = new Variable("do", "bool");
		...
		flagVariables.add(whileFlag);
		flagVariables.add(doFlag);
...
//		return wrap(str);
	...
	protected Variable whileFlag;
	protected Variable doFlag;	// do-while
